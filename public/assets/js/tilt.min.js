...
! function (t) {
    t.fn.tilt = function (i) {
        var s = this,
            ...
            n = function () {
                t(this).on("mousemove", r), t(this).on("mouseenter", h), this.settings.reset && t(this).on("mouseleave", c)
            },
            a = function () {
                var i = this;
            ...
            c = function () {
                a.call(this), this.reset = !0, e.call(this), t(this).trigger("tilt.mouseLeave")
            },
            l = function () {
                var i = this.clientWidth,
                    ...
                    a = (this.settings.maxTilt / 2 - e * this.settings.maxTilt).toFixed(2),
                    h = (n * this.settings.maxTilt - this.settings.maxTilt / 2).toFixed(2);
                return {
                    tiltX: a,
                    tiltY: h,
                    percentageX: 100 * e,
